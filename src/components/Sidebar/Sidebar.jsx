    ...
    <>
      ...
      <List>
        ...
        {categories.map(({ label, value }) => (
          <Link key={value} className={classes.list} to="/">
            <ListItemButton onClick={() => dispatch(selectGenreOrCategory(value))} className={classes.links}>
              <ListItemIcon>
      ...
      <List>
        ...
        {isFetching ? (
          ...
          <Link key={name} className={classes.list} to="/">
